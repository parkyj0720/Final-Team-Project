...
<body>
	...
	if ((String) request.getAttribute("inputSearch") != null) {
		inputSearch = (String) request.getAttribute("inputSearch");
	}
	ArrayList<CommunityDto> list = new ArrayList<CommunityDto>();
	if ((ArrayList<CommunityDto>) request.getAttribute("list") != null) {
		list = (ArrayList<CommunityDto>) request.getAttribute("list");
	}
	...
	<div class="body_scroll">
		<div class="block-header">
			...
			<div class="search_div" style="position: relative;">
				<form
					action="${pageContext.request.contextPath}/Community_search.do?list=<%=boardnum%>"
				...
				<div class="col-lg-12">
					<div class="card"">
						<div class="table-responsive">
								...
								<thead>
									<tr height="40px" width="100%"
										...
										<th width="10%" height="auto"
											style="text-align: center; color: black;">번호</th>
										<th width="10%" height="auto"
											style="text-align: center; color: black;">글쓴이</th>
										<th width="50%" height="auto"
											style="text-align: center; color: black;">제목</th>
										<th width="10%" height="auto"
											style="text-align: center; color: black;">시간</th>
										<th width="10%" height="auto"
											style="text-align: center; color: black;">조회수</th>
										<th width="10%" height="auto"
											style="text-align: center; color: black;">좋아요</th>
									</tr>
								</thead>
								<%
									if (list.size() == 0) {
							...
							<div align="center" style="height: 10em">
								<div align="center" style="margin-top: 8em;">아직 게시글이
									없습니다.</div>
							</div>
						...
						<div class="body">
							...
							<ul class="pagination pagination-primary m-b-0">
								<li class="page-item"><a class="page-link"
									href="${pageContext.request.contextPath}/Community_list.do?list=<%=boardnum %>&page=<%=(startPage-maxPage>0)?startPage-maxPage:1%>"><i
								...
								<li class="page-item active"><a class="page-link"
									href="${pageContext.request.contextPath}/Community_list.do?list=<%=boardnum%>&page=<%=i+1%>"><%=i + 1%></a></li>
								<%
									} else {
								%>
								...
								<li class="page-item"><a class="page-link"
									href="${pageContext.request.contextPath}/Community_list.do?list=<%=boardnum%>&page=<%=(endPage+maxPage>=pageCount)?pageCount:endPage+1%>"><i
							...
							<ul class="pagination pagination-primary m-b-0">
								<li class="page-item"><a class="page-link"
									href="${pageContext.request.contextPath}/Community_search.do?list=<%=boardnum%>&inputSearch=<%=inputSearch %>&page=<%=(startPage-maxPage>0)?startPage-maxPage:1%>"><i
										class="zmdi zmdi-arrow-left"></i></a></li>
										<%
										if(list.size() == 0){
											%>
											<li class="page-item active"><a class="page-link"
													href="${pageContext.request.contextPath}/Community_search.do?list=<%=boardnum%>&inputSearch=<%=inputSearch %>&page=1">1</a></li>
													<%
										}
								...
								<li class="page-item active"><a class="page-link"
									href="${pageContext.request.contextPath}/Community_search.do?list=<%=boardnum%>&inputSearch=<%=inputSearch %>&page=<%=i+1%>"><%=i + 1%></a></li>
								<%
									} else {
								%>
								...
								<li class="page-item"><a class="page-link"
									href="${pageContext.request.contextPath}/Community_search.do?list=<%=boardnum %>&inputSearch=<%=inputSearch %>&page=<%=(endPage+maxPage>=pageCount)?pageCount:endPage+1%>"><i
										class="zmdi zmdi-arrow-right"></i></a></li>
								<div style="width: 100%"></div>
								<button class="btn btn-primary float-right" type="button"
									id="input">
