...
<script>$('document').ready(function() {
       var area0 = ["시/도 선택","서울특별시","인천광역시","대전광역시","광주광역시","대구광역시","울산광역시","부산광역시","경기도","강원도","충청북도","충청남도","전라북도","전라남도","경상북도","경상남도","제주도"];
        var area1 = ["강남구","강동구","강북구","강서구","관악구","광진구","구로구","금천구","노원구","도봉구","동대문구","동작구","마포구","서대문구","서초구","성동구","성북구","송파구","양천구","영등포구","용산구","은평구","종로구","중구","중랑구"];
         ...
         var a = [area0,area1,area2,area3,area4,area5,area6,area7,area8,area9,area10,area11,area12,area13,area14,area15,area16];
       // 시/도 선택 박스 초기화
       ...
       $("select[name=sido1]").each(function() {
        ...
        $('select[name=gugun1]').append("<option value=''>구/군 선택</option>");
       });
       ...
       $("select[name=sido1]").change(function() {
        ...
        var $gugun = $('select[name=gugun1]'); // 선택영역 군구 객체
        console.log($gugun);
        console.dir($gugun);
        ...
        if(area == "area0")
         ...
         $.each(eval(a[area.substring(4)]), function() {
