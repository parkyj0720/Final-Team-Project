...
String BRD_WRT_ID = (String) request.getParameter("BRD_WRT_ID");

System.out.println(BRD_TIT);
System.out.println(BRD_CONTENT);
System.out.println(CATEGORY_IDX);
System.out.println(BRD_WRT_ID);

String returns = appDao.writeDb(BRD_TIT, BRD_CONTENT, CATEGORY_IDX, BRD_WRT_ID);
