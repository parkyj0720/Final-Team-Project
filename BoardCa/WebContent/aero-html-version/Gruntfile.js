module.exports = function(grunt) {
    grunt.initConfig({
        ...
        uglify: {
            my_target: {
                files: {
                    'assets/bundles/libscripts.bundle.js': ['assets/plugins/jquery/jquery-v3.3.1.min.js','assets/plugins/bootstrap/js/bootstrap.bundle.js'], /* main js*/              
                    
                    'assets/bundles/vendorscripts.bundle.js': ['assets/plugins/bootstrap-select/js/bootstrap-select.js','assets/plugins/jquery-slimscroll/jquery.slimscroll.js','assets/plugins/node-waves/waves.js'], /* coman js*/
                    ...
                    'assets/bundles/morrisscripts.bundle.js': ['assets/plugins/raphael/raphael.js','assets/plugins/morrisjs/morris.js'], /* Morris Plugin Js */
                    ...
                    'assets/bundles/fullcalendarscripts.bundle.js': ['assets/plugins/fullcalendar/moment.min.js', 'assets/plugins/fullcalendar/fullcalendar.min.js'],   /* calender page js */
