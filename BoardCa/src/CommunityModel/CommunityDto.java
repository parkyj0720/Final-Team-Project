...
public class CommunityDto {
	...
	public CommunityDto(int BRD_IDX, String BRD_TIT, String BRD_WRT_NICKNAME, Timestamp BRD_SYSDATE, String BRD_CONTENT, int BRD_VIEWS, int CATEGORY_IDX) {
		this.BRD_IDX = BRD_IDX;
		this.BRD_TIT = BRD_TIT;
		this.BRD_WRT_NICKNAME = BRD_WRT_NICKNAME;
	...
	public CommunityDto(int BRD_IDX, String BRD_TIT, String BRD_WRT_NICKNAME, Timestamp BRD_SYSDATE, String BRD_CONTENT, int BRD_VIEWS, int CATEGORY_IDX, int HEART_SIZE) {
		this.BRD_IDX = BRD_IDX;
		this.BRD_TIT = BRD_TIT;
		this.BRD_WRT_NICKNAME = BRD_WRT_NICKNAME;
		this.BRD_SYSDATE = BRD_SYSDATE;
	...
	public String getBRD_WRT_NICKNAME() {
		return BRD_WRT_NICKNAME;
	}

	public void setBRD_WRT_NICKNAME(String bRD_WRT_NICKNAME) {
		BRD_WRT_NICKNAME = bRD_WRT_NICKNAME;
	}
	...
	public String toString() {
		return "CommunityDto [BRD_IDX=" + BRD_IDX + ", BRD_TIT=" + BRD_TIT + ", BRD_WRT_NICKNAME=" + BRD_WRT_NICKNAME
				+ ", BRD_SYSDATE=" + BRD_SYSDATE + ", BRD_CONTENT=" + BRD_CONTENT + ", BRD_VIEWS=" + BRD_VIEWS
				+ ", CATEGORY_IDX=" + CATEGORY_IDX + ", COUNT=" + COUNT + "]";
	}
